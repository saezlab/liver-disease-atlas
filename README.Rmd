...
<!-- badges: start -->
**Publication:** [![DOI](https://img.shields.io/badge/DOI-10.1002/hep4.1797-red.svg)](https://doi.org/10.1002/hep4.1797)
**Data:** [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.4407207.svg)](https://doi.org/10.5281/zenodo.4407207)
<!-- badges: end -->

This repository contains the code for the analyses presented in _"[Transcriptomic cross-species analysis of chronic liver disease reveals a consistent regulation pattern between humans and mice](https://doi.org/10.1002/hep4.1797)"_.
