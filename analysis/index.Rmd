...
3. The GitHub repository contains only the analysis code and same small objects. All raw data is deposited at [Zenodo](https://doi.org/10.5281/zenodo.4407208). Download the zipped `data` folder unzipp it and replace the existing `data` folder at the root level of the R-project.
