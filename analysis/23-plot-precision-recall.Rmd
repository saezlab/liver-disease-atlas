...
```{r pr-scatter-plot-combined-mouse-models}
keys <- key_mm %>%
  distinct(study = contrast, label2)
...
### Figure 6
Main Figure.
```{r fig-6, fig.width=8.27, fig.height=11.69}
...
```{r fig-6-1, fig.width=8.27, fig.height=11.69}
...
```{r fig-6-2, fig.width=8.27, fig.height=11.69}
